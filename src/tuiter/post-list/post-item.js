...
const PostItem = ({post}) => {
    return(
        <li className="list-group-item">
            <div className="row">
                <div className="col-2">
                    <img src={"../../assets/nasa.png"} className="rounded-circle wd-profile-image"/>
                </div>
                ...
                <div className="col">
                    ...
                    <div className="m-3 wd-bookmark-footer d-flex justify-content-between">
                        <a href="src/tuiter/post-list/post-item#" className="wd-bookmark-comment">
                        <i className="fa fa-comment-o" aria-hidden="true"><span className="m-2 wd-count">45</span></i>
                        </a>
                        <a href="src/tuiter/post-list/post-item#" className="wd-bookmark-retweet">
                        <i className="fa fa-retweet" aria-hidden="true"><span className="m-2 wd-count">45</span></i>
                        </a>
                        <a href="src/tuiter/post-list/post-item#" className="wd-bookmark-like">
                        <i className="fa fa-heart wd-liked" aria-hidden="true"><span className="m-2 wd-count wd-liked">45</span></i>
                        </a>
                        <a href="src/tuiter/post-list/post-item#" className="wd-bookmark-upload">
